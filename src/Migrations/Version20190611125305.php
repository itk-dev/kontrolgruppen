 ...
 */
final class Version20190611125305 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE process_log_entry (id INT AUTO_INCREMENT NOT NULL, process_id INT NOT NULL, log_entry_id INT NOT NULL, level VARCHAR(255) NOT NULL, created_by VARCHAR(255) DEFAULT NULL, updated_by VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_911634C57EC2F574 (process_id), INDEX IDX_911634C5D465829D (log_entry_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
