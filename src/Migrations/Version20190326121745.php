 ...
 */
final class Version20190326121745 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE process (id INT AUTO_INCREMENT NOT NULL, case_worker_id INT DEFAULT NULL, INDEX IDX_861D18964503CACD (case_worker_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
