 ...
 */
final class Version20190625111012 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE process ADD reason_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE process ADD CONSTRAINT FK_861D189659BB1592 FOREIGN KEY (reason_id) REFERENCES reason (id)');
        $this->addSql('CREATE INDEX IDX_861D189659BB1592 ON process (reason_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_861D189659BB1592 ON process');
        $this->addSql('ALTER TABLE process DROP reason_id');
    }
}
